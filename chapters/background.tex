...
revisadas duas das definições formais para o problema mais utilizadas. Em 
...
\acp{ga}. Dessa forma, nos próximos capítulos, serão apresentados alguns 
algoritmos evolucionários que podem ser utilizados para resolver a \ac{tmap}, 
em seguida, serão propostas formas de aplicar esses algoritmos no contexto do 
problema e, finalmente, será demonstrada a eficácia dessas estratégias perante 
as abordagens de destaque propostas por outros autores.
