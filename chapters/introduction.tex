...
entre esses pontos. Na \figref{fig:graphexample}, visualiza-se um exemplo de 
...
Tendo em vista tal objetivo geral, este projeto visa atingir os seguintes 
...
Esta monografia está estruturada da seguinte forma: no \chapref{chp:background} 
foi realizada uma revisão da literatura sobre a \ac{tmap}. O \chapref{alg_evo} 
apresenta ao leitor os algoritmos evolucionários utilizados nesta pesquisa para 
obter soluções da \ac{tmap}. Em seguida, o \chapref{chp:abordagens} propõe  
operadores que foram utilizados para possibilitar a implementação dos algoritmos 
evolucionários no contexto da \ac{tmap}. O \chapref{experimentos} descreve os 
experimentos realizados para provar a eficácia e relevância das abordagens aqui 
propostas. Finalmente, o \chapref{conclusao_final} faz uma análise do trabalho 
